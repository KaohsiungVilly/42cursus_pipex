...
/*   Updated: 2022/03/14 14:41:34 by pvillena         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "pipex.h"

size_t	ft_lenchar(char *str, char c)
{
	size_t	len;
...
char	*ft_read_buffer_size(char *buffer_read, int *n, int fd)
{
	char	*temp;
	char	*temp2;
...
char	*ft_linecpy(char *buffer_read)
{
	char	*next_line;
	char	*p;
...
char	*new_buffer_read(char *buffer_read)
{
	char	*new_buffer;
	char	*p;
	int		i;
